...
class Siswa_m extends CI_Model
{
    ...
    public function add()
    {
        ...
        $this->session->set_flashdata('msg', '<div class="alert alert-success alert-dismissible fade show" role="alert"><strong>Congratulation !</strong>Data successfully added.</div>');
        redirect('Siswa');
    }
